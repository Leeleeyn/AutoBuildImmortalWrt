...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-ath9k-common"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-cfg80211"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-mac80211"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES rtl8192eu-firmware"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-rtl8xxxu"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-rtlwifi"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-rtlwifi-usb"
#vlmcsd
...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES hostapd-common" 
#lsusb
